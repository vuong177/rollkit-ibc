...
from_scratch () {
  ...
  gaiad add-genesis-account $KEY 12220000000000000uatom,10000233333000000000stake,100000000000000utest --keyring-backend $KEYRING
  gaiad add-genesis-account gnad 10000000000000uatom,10000000000000stake,100000000000000utest --keyring-backend $KEYRING
  
  gaiad gentx $KEY 12340000000000stake --keyring-backend $KEYRING --chain-id $CHAINID
