...
func (*MsgUpdateParams) Descriptor() ([]byte, []int) {
	return fileDescriptor_30eec58d2e809442, []int{0}
}
...
func (*MsgUpdateParamsResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_30eec58d2e809442, []int{1}
}
...
func init() {
	proto.RegisterType((*MsgUpdateParams)(nil), "rollkitibc.rollkitibc.MsgUpdateParams")
	proto.RegisterType((*MsgUpdateParamsResponse)(nil), "rollkitibc.rollkitibc.MsgUpdateParamsResponse")
}

func init() { proto.RegisterFile("rollkitibc/rollkitibc/tx.proto", fileDescriptor_30eec58d2e809442) }

var fileDescriptor_30eec58d2e809442 = []byte{
	// 322 bytes of a gzipped FileDescriptorProto
	0x1f, 0x8b, 0x08, 0x00, 0x00, 0x00, 0x00, 0x00, 0x02, 0xff, 0xe2, 0x92, 0x2b, 0xca, 0xcf, 0xc9,
	0xc9, 0xce, 0x2c, 0xc9, 0x4c, 0x4a, 0xd6, 0x47, 0x62, 0x96, 0x54, 0xe8, 0x15, 0x14, 0xe5, 0x97,
	...
	0x8f, 0xe5, 0x18, 0xa2, 0x60, 0x89, 0x45, 0x17, 0xc3, 0x53, 0x25, 0x95, 0x05, 0xa9, 0xc5, 0x49,
	0x6c, 0xe0, 0xb8, 0x31, 0x06, 0x04, 0x00, 0x00, 0xff, 0xff, 0x07, 0x96, 0x21, 0x98, 0x55, 0x02,
	0x00, 0x00,
}
...
func (c *msgClient) UpdateParams(ctx context.Context, in *MsgUpdateParams, opts ...grpc.CallOption) (*MsgUpdateParamsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/rollkitibc.rollkitibc.Msg/UpdateParams", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Msg_UpdateParams_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/rollkitibc.rollkitibc.Msg/UpdateParams",
	}
...
var _Msg_serviceDesc = grpc.ServiceDesc{
	ServiceName: "rollkitibc.rollkitibc.Msg",
	...
	Metadata: "rollkitibc/rollkitibc/tx.proto",
}
